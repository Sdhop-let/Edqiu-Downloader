...
object DownloadIntentContract {
    const val ACTION_DOWNLOAD_TWEET = "com.ed.Edqiu.action.DOWNLOAD_TWEET"
    const val EXTRA_TWEET_URL = "com.ed.Edqiu.extra.TWEET_URL"
    private const val LEGACY_EXTRA_TWEET_URL = "com.ed.edqiu.extra.TWEET_URL"
    private const val OLDEST_EXTRA_TWEET_URL = "com.ed.twitterdownload.extra.TWEET_URL"
    ...
    fun extractUrl(intent: Intent?): String? {
        ...
        return sequenceOf(
            ...
            intent.getStringExtra(OLDEST_EXTRA_TWEET_URL)
