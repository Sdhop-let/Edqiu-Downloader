package com.ed.twitterdownloader.navigation
...
import com.ed.twitterdownloader.ui.screens.DownloadScreen
import com.ed.twitterdownloader.ui.screens.HomeScreen
import com.ed.twitterdownloader.ui.screens.MediaLibraryScreen
import com.ed.twitterdownloader.ui.screens.PlayerScreen
import com.ed.twitterdownloader.ui.screens.SettingsScreen
import com.ed.twitterdownloader.viewmodel.DownloadViewModel
import com.ed.twitterdownloader.viewmodel.HistoryViewModel
import com.ed.twitterdownloader.viewmodel.PlayerViewModel
...
fun AppNavigation(
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        // 悬浮液态胶囊 Tab 栏：处于 Box overlay，bottom 28dp 间隙，内容从下方透出
        if (showBottomBar) {
            LiquidTabBar(
